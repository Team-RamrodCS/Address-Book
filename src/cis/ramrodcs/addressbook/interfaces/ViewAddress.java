...
public class ViewAddress extends JPanel {

  private JTextField[] fields;

  // Create a form with the specified labels, tooltips, and sizes.
  public ViewAddress(String[] labels, char[] mnemonics, int[] widths, String[] tips) {
  ...
  public static void main(String[] args) {
    ...
    final ViewAddress form = new ViewAddress(labels, mnemonics, widths, descs);
